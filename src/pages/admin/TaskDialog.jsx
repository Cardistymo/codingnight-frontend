...
export default function TaskDialog({ userID, update }) {
    ...
    if (!newUser) {
        return (
            <dialog id="view_user_tasks_modal" className="modal">
                <div
                    ...
                    <p className={"font-semibold text-xl mb-8"}>Edit User (Tasks)</p>
        ...
        <dialog id="view_user_tasks_modal" className="modal">
            <div
                ...
                <div className={"grid grid-cols-2 items-center justify-center gap-y-5 gap-x-5 mb-6 w-full"}>
                    ...
                    <CustomInput label={{label: "Task"}} value={newUser.taskIndex}/>
                </div>
